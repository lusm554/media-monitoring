...
def setup(telegram_app, users_blacklist):
  ...
  setup_bot_data_variables(telegram_app, commands, users_blacklist=users_blacklist)
...
def start(BOT_TOKEN, USERS_BLACKLIST):
  telegram_app = ApplicationBuilder().token(BOT_TOKEN).build()
  setup(telegram_app, users_blacklist=USERS_BLACKLIST)
